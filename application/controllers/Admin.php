...
class Admin extends CI_Controller
{
    ...
    protected function getResaleImageName($data){
        ...
        if ($results){
            ...
            foreach ($results as $result){
                array_push($IIG,array('image'=>$result->image,'sort'=>$result->sort_priority));
            }
            return $IIG;
        }else{
            return false;
    ...
    public function PublishResale($passed_url)
    {
        ...
        $roll = array (
            ...
            'Property_thumbnail'=>'assets/thumbnail/'.$image_name,
        ...
        foreach ($images as $image_name){
            $this->insert_gallery_images($insert_id,$image_name['image'],$image_name['sort']);
        }
