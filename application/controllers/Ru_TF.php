...
class Ru_TF extends CI_Controller
{
    ...
    public function index($passed_url ='')
    {
        ...
        if ($find_string){
            if ($type!='Commercial'){
                ...
                if ($data['all']) {
                    $data['page_url']= base_url()."ru/Turkey/".$given_array[0]."/".$given_array[1]."/".$given_array[2]."/".$given_array[3];
                    ...
                    $this->load->view('web-site/ru/properties/find-result', $data);
                }else{
