...
if ( ! function_exists('create_captcha'))
{
    ...
    function create_captcha($data = '', $img_path = '', $img_url = '', $font_path = '')
    {
        $defaults = array(
            ...
            'font_path'     => base_url().'assets/web-site/fonts/font.ttc',
            'img_width'	=> '150',
            'img_height'	=> '30',
            'expiration'	=> 7200,
            'word_length'	=> 4,
            'font_size'	=> 24,
            'img_id'	=> 'captcha-image-id',
            'pool'		=> '0123456789',
            'colors'	=> array(
                'background'	=> array(255,255,255),
                'border'	=> array(1,33,105),
                'text'		=> array(1,33,105),
        ...
        $img = '<img '.($img_id === '' ? '' : 'id="'.$img_id.'"').' src="'.$img_url.$img_filename.'" style="width: '.$img_width.'px; height: '.$img_height .'px; border: 0;" alt="prime property turkey - captcha " class="captcha-image-id" />';
        ImageDestroy($im);
