                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="page-title col-md-6 text-right">
                            <a href="<?= base_url(); ?>Admin/Add_Videos" class="btn btn-lg btn-primary"><i class="far fa-plus-square px-2"></i> Add Videos</a>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <td class="td-actions">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a href="<?= base_url("Admin/Edit_Videos/$row->id"); ?>" class="dropdown-item">Edit</a>
                                                <a href="<?= base_url("Admin/Delete_Videos/$row->id"); ?>" class="dropdown-item">Delete</a>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
