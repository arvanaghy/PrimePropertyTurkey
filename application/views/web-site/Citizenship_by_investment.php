                    ...
                    <div class="card" style="background-color: #ffffff">
                        <div class="card-body">
                            ...
                            <p class="px-3 py-4 bg-light">
                                In order to draw foreign direct investment and boost growth in the country's real estate
                                industry, the Türkiye Citizenship by Investment Program (formerly known as the Turkey
                                Citizenship by Investment Program) was introduced in January 2017. The program gives
                                candidates a variety of options for economic contributions to Turkish society that will
                            ...
                            <ul class="mt-5 mb-4">
                                <li>
                                    Foreign investors will have visa-free travel to 110 countries, including Hong Kong,
                                    Japan, and Singapore.
                                </li>
                                <li>
                            ...
                            <p class="px-3 mt-5">
                                ...
                                selecting the acceptable investment option. After that, the primary applicant must
                            ...
                            <p class="px-2 my-3">
                                After the purchase of real estate property, the paperwork is submitted to the
                                government. All application materials, including certificates and translations, will be
                                checked, the review procedure will start, then an interview request is submitted.
                                Usually, it takes 120 days for applications to be granted, after which citizenship
                                documents are provided. After that, the passport application may be turned in.
                            </p>
                            <div id="design-sector" class="my-4 mx-3 bg-light">
                                ...
                                <div class="row align-items-center"
                                    ...
                                    <div class="col-md-10 col-8  text-left text-md-justify"
                                         style="background-color: #DDDDDD">
                                        <p>
                                            If the applicant has residency in Turkey, the applicant must provide a
                                            residency id photocopy.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="row align-items-center"
                                    ...
                                    <div class="col-10  text-left text-md-justify" style="background-color: #EBEBEB">
                                        <p>
                                            ...
                                            <br>
                                            Foreign nationals who acquire Turkish citizenship are eligible for health
                                            care for themselves and their families. You and your family will enjoy
                                ...
                                <div class="row align-items-center"
                                    ...
                                    <div class="col-10  text-left text-md-justify" style="background-color: #EBEBEB">
                                        <p>
                                            ...
                                            country that forbids dual citizenship and meets the Turquoise Card
                                ...
                                <div class="row align-items-center"
                                    ...
                                    <div class="col-10  text-left text-md-justify" style="background-color: #DDDDDD">
                                        <p>
                                            ...
                                            <br>
                                            It is essential to have a residence permit or work permit. Renew it to live
                                ...
                                <div class="row align-items-center"
                                    ...
                                    <div class="col-10  text-left text-md-justify" style="background-color: #DDDDDD;">
                                        <p>
                                            ...
                                            acquires Turkish citizenship has the right to retire as long as the
