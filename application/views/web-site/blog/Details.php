                    ...
                    <div class="card" style="background-color: #efefef;">
                        <div class="card-body my-2">
                            <div class="useful px-4 py-2">
                                ...
                                <a href="<?= base_url(); ?>Like/blog/<?= $result->Blog_ID; ?>" <? if (is_blogDisliked($result->Blog_ID)) { ?> style="pointer-events: none;" <? } ?> rel="nofollow" ><? if (is_blogLiked($result->Blog_ID)) { ?>
                                        <span class="px-1"><i class="fas fa-thumbs-up"></i></span><? } else { ?><i
                                            class="far fa-thumbs-up"></i></span><? } ?></a>
                                <a href="<?= base_url(); ?>Dislike/blog/<?= $result->Blog_ID; ?>" <? if (is_blogLiked($result->Blog_ID)) { ?> style="pointer-events: none;" <? } ?> rel="nofollow" ><? if (is_blogDisliked($result->Blog_ID)) { ?>
