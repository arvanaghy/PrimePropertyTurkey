...
<div class="card-body">
    <form action="<?= base_url();?>Post/contact_us" method="post" onsubmit="return sideContactFormValidation();" class="row">
        ...
        <div class="col-md-12 col-lg-12 form-group" id="message">
            <textarea type="text" class="form-control" name="message" placeholder="Message" required></textarea>
        </div>
        <div class="col-md-12 col-lg-12 form-group d-flex justify-content-center">
