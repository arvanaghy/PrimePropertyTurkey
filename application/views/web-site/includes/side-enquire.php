...
<div class="card-body" id="side-garde">
    <form action="<?= base_url(); ?>Post/enquire" method="post" onsubmit="return sideEnquireFormValidation();" class="row">
        <div class="col-lg-12 col-md-4 form-group">
        ...
        <div class="col-lg-12 col-md-12 form-group" id="note">
