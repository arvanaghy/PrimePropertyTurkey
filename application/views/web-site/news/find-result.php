    ...
    <section id="theme-background">
        <div class="header-image-wrapper">
            ...
            <div class="header-image-content offset-bottom">
                <h1 class="title text-center font-weight-bold px-1">Prime Property Turkey News</h1>
                                ...
                                <div class="card-body">
                                    <div class="container-fluid">
                                        ...
                                        <div class="row mt-2 mx-3 mb-4 justify-content-center">
                                            <a href="<?= base_url();?>news/<?= $value->url_slug;?>" class="text-reset font-weight-bold">
                                                <?= $value->News_Title; ?>
                                            </a>
                                        </div>
                                        <div class="row my-2">
                                ...
                                <div class="card-body">
                                    <div class="row justify-content-around">
                                        <div class="col-5 d-flex">
                                            ...
                                            ?>
                                            <img src="<?= base_url(); ?><?= "assets/web-site/images/news/thumb/".$image_name_webp; ?>"
                                                 alt="<?= $value->News_Image_Alt; ?>"
                                                 class="img-fluid">
                                        </div>
                                        <div class="col-7">
                                            ...
                                            <div class="row mt-5 mb-4 justify-content-start p-1">
                                                <a href="<?= base_url();?>news/<?= $value->url_slug;?>" class="text-reset font-weight-bold blog-title-text">
                                                    <?= $value->News_Title; ?>
                                                </a>
                                            </div>
                                            <div class="row my-2">
                                ...
                                <div class="col">
                                    <nav aria-label="Page navigation example">
                                        <ul class="pagination justify-content-center">
                                            <li class="page-item">
                                                <a class="page-link" rel="nofollow" href="<?= base_url(); ?>NewsFind" tabindex="-1" title="FIRST"> <i
                                                ...
                                                <? for ($i = 0; $i <= $page_id+2; $i++) { ?>
                                                    ...
                                                    <? if ((int)$page_id == $i) { ?>
                                                        <li class="page-item text-danger"><a rel="nofollow" class="page-link text-danger"
                                                                                             href="<?= base_url(); ?>NewsFind/<?= $i; ?>"><?= $i + 1; ?></a>
                                                        </li>
                                                    <? } else { ?>
                                            ...
                                            <? } ?>
                                            <li class="page-item">
                                                <a class="page-link" rel="nofollow" href="<?= base_url(); ?>NewsFind/<?= $pages; ?>" title="LAST"> <i
