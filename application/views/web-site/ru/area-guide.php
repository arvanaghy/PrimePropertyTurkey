...
<section id="theme-background">
    <div class="header-image-wrapper">
        ...
        <div class="header-image-content offset-bottom">
            <h1 class="title text-center px-1 font-weight-bold">Путеводитель по Стамбулу</h1>
        </div>
    </div>
</section>
                ...
                <div class="card my-2">
                    <div class="card-body px-4 pt-4 pb-1">
                        ...
                        <p class="px-4 mb-0 py-1 text-justify">
                            ...
                            <br>Понимание ваших целей - ключ к тому, чтобы мы предоставили лучшую недвижимость с наилучшим результатом.
                        </p>
                        <p class="px-4 mb-0 py-1 text-justify">
                        ...
                        <img src="<?= base_url(); ?>assets/web-site/images/base/area guide/area-2.jpg"
                             alt="area guide"
                             class="img-fluid px-3">
                        <h2 class="pt-4 pb-2 px-4 font-weight-bold"> Западный Стамбул </h2>
                        <p class="px-4 mb-0 py-1 text-justify">
