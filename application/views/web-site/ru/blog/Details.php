...
<?php if ($result->ru_title): ?>
<?php $this->load->view('web-site/ru/includes/head-load'); ?>
<link rel="stylesheet" href="<?= base_url(); ?>assets/web-site/css/blog.css">
<title><?= $result->ru_meta_title; ?></title>

<meta name="keywords" content="<?= $result->ru_meta_keyword; ?>">
<meta name="description" content="<?= $result->ru_meta_description; ?>">

<meta property="og:type" content="website">
<meta property="og:url" content="<?= current_url(); ?>">
<meta property="og:title" content="<?= $result->ru_title; ?>">
<meta property="og:description" content="<?= $result->ru_meta_description; ?>">
...
<meta name="twitter:image:alt" content="<?= $result->ru_image_alt; ?>">
<meta name="twitter:title" content="<?= $result->ru_meta_title; ?>">
<meta name="twitter:description" content="<?= $result->ru_meta_description; ?>">
<meta name="twitter:image"
      content="<?= base_url(); ?><?= "assets/web-site/images/blog/old/original/" . str_replace('assets/blog/', '', $result->Blog_Image); ?>">
<link rel="canonical" href="<?= base_url(); ?>ru/blog/<?= $result->url_slug; ?>"/>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col offset-md-1  red-text py-3 text-center text-md-left">
                ...
                <span class="mx-2">
                        <a href="<?= base_url(); ?>ru/blog" class="red-text" >
                           Блог
                        </a>
                    </span>
                <span class="mx-2">
        ...
        <div class="row ">
            <div class="col-md-7 offset-md-1 text-center text-md-left py-2">
                <div class="head text-center text-md-left py-2">
                    <h1 style="font-size: 2rem"><?= $result->ru_title; ?></h1>
                </div>
                <div class="sub-head text-center text-md-left">
                        <span class="red-text">
                            <i class="far fa-clock"></i>
                        </span>
                    <span class="red-text font-weight-bold"> Созданный :  </span>
    ...
    <div class="container-fluid my-3">
        <div class="row">
                    ...
                    <div class="card my-2"  style="background-color: #efefef;">
                        <div class="card-body m-3 font-weight-bold">
                            <div class="card-title">
                                Комментарии наших клиентов об этом посте
                            </div>
            ...
            <div class="col-md-3">
                ...
                <? $this->load->view('web-site/ru/includes/side-enquire',$passed_data); ?>
