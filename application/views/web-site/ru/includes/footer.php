...
<!--    <style scoped> .brandpush-logo-container-item {-->
<!--            height: 100px;-->
<!--            position: relative;-->
<!--        }-->
<!---->
...
<!--                    <div class="brandpush-vertical-center"><a href='http://www.wicz.com/story/47126906/prime-property-turkey-ramps-up-efforts-to-help-individuals-obtain-turkish-citizenship-through-real-estate-investment-->
<!-- ' target='_Blank' ><img alt="Featured on FOX News" class="brandpush-news-logo"-->
...
<!--                                href='http://digitaljournal.com/pr/prime-property-turkey-ramps-up-efforts-to-help-individuals-obtain-turkish-citize-->
<!-- ' target='_Blank' ><img alt="Featured on DigitalJournal" class="brandpush-news-logo"-->
...
<!--                                href='https://www.newschannelnebraska.com/story/47126906/prime-property-turkey-ramps-up-efforts-to-help-individuals-obtain-turkish-citizenship-through-real-estate-investment-->
<!-- ' target='_Blank' ><img alt="Featured on NCN" class="brandpush-news-logo" style="max-width: 80px;"-->
...
<!--                                href='https://www.marketwatch.com/press-release/prime-property-turkey-ramps-up-efforts-to-help-individuals-obtain-turkish-citizenship-through-real-estate-investment-2022-08-19-->
<!-- ' target='_Blank' ><img alt="Featured on Market Watch" class="brandpush-news-logo"-->
...
<!--                                href='https://www.benzinga.com/pressreleases/22/08/ab28571314/prime-property-turkey-ramps-up-efforts-to-help-individuals-obtain-turkish-citizenship-through-rea-->
<!-- ' target='_Blank' ><img alt="Featured on Benzinga" class="brandpush-news-logo" style="max-width: 125px;"-->
...
<!--                    </div>-->
<!--                </div>-->
<!--                <div><span class="brandpush-footer"-->
<!--                           style=" text-align: center; padding: 0 20px; font-size: 13px; font-family: sans-serif; font-weight: 600; letter-spacing: 3px; position: relative; width: 100%; margin: 0 0 8px 0; display: inline-block; color: #a5a5a5;">AND OVER 450 NEWS SITES</span>-->
<!--                    -->
...
<!--                                    style="color:#717171;"-->
<!--                                    href="https://www.brandpush.co?utm_source=Client+Referral&utm_medium=Trust+Badge&utm_campaign=Trust+Badge&utm_content=1660213656419"-->
...
<!-- End of BrandPush Trust Badge -->
        ...
        <div class="container-fluid py-3 py-md-5">
            <div class="row text-white">
                <div class="col-md-4 pl-md-5 px-md-0 px-2 justify-content-center text-white" id="footerDescription">
                    ...
                    <div class="footer-social-media text-white px-3 align-items-center">
                        <span class="mx-1">
                            <a href="https://www.facebook.com/primepropertyturkeyistanbul" target="_blank"
                               >
                        ...
                        <span class="mx-1">
                            <a href="https://www.linkedin.com/company/prime-property-turkey" target="_blank"
                               >
                                <i class="fab fa-linkedin"></i>
                            </a>
                        </span>
                        <span class="mx-1">
                            <a href="https://tr.pinterest.com/primepropertyturkey/" target="_blank" >
                ...
                <div class="col-md-3 my-4 my-md-0 justify-content-center" id="UsefulLinksFooter">
                    ...
                    <ul>
                        ...
                        <li>
                            <i class="fas fa-chevron-right red-text mx-1"></i>
                            <a href="<?= base_url(); ?>How-To-Buy-Property-In-Turkey">
            ...
            <div class="row justify-content-center">
                <div class="Copyright text-white text-center mx-2 my-2">
                    Copyright © 2021 Prime Property Turkey Limited. Все права защищены.
                </div>
            </div>
        </div>
    </section>
    <div class="nz-phone-phone nz-phone-green nz-phone-show" id="nz-phone-phoneIcon">
        ...
        <div class="nz-phone-ph-img-circle">
            ...
            <a href="https://wa.me/905527544493/?text=Intersted In <?php echo $property_title; ?> Property With <?php echo $property_reference; ?> Reference ID "
               target="_blank" rel="nofollow">
                ...
                <a href="https://wa.me/905527544493/?text=PrimePropertyTurkey" target="_blank" rel="nofollow">
                    <? } ?>
                    <span class="round">
                <i class="fab fa-whatsapp faa-ring faa-slow animated"></i>
            </span>
                </a>
...
<!--    </script>-->
<!--    <noscript>-->
<!--        <div><img src="https://mc.yandex.ru/watch/89644195" style="position:absolute; left:-9999px;" alt=""/>-->
<!--        </div>-->
<!--    </noscript>-->
    <!-- /Yandex.Metrika counter -->
    ...
    if (get_cookie('favorite') != null) { ?>
        <a href="<?= base_url(); ?>Properties/favorite" id="goto_favorite_page" rel="nofollow">
...
<!-- End Google Tag Manager (noscript) -->
    ...
    <!-- Google Tag Manager (noscript) -->
<!--    <noscript>-->
<!--        <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-N243V5Z"-->
