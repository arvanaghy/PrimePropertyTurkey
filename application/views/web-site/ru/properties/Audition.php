...
<meta name="twitter:site" content="https://www.primepropertyturkey.com/ru/properties/<?= $data_array->url_slug;?>">
        ...
        <div class="container">
            <div class="row">
                <div class="col red-text py-3 text-center text-md-left">
                    ...
                    <span class="mx-2">
                        <a href="<?= base_url(); ?>ru/properties" class="red-text" >
                            Параметры
                        </a>
                    </span>
                    <span class="mx-2">
            ...
            <div class="row">
                <div class="col-md-9 text-center text-md-left py-2">
                    ...
                    <div class="sub-head text-center text-md-left">
                        <span class="red-text font-weight-bold"> Цена :  </span>
                    ...
                    <div class="sub-head text-center text-md-left mt-2">
                        ...
                        <span class="red-text font-weight-bold"> Создано :  </span>
                        <span class="font-weight-bold">
                        ...
                        <? if ($data_array->updated_time and $created_date != $update_date) {?>
                            ...
                            <span class="red-text font-weight-bold"> Обновлено :  </span>
                            <span class="font-weight-bold">
                               <? $unix_time= mysql_to_unix($data_array->updated_time);
                               $date_string = '%d %M %Y';
                ...
                <div class="col-lg-8 details">
                    ...
                    <? if ($data_array->SoldOut){ ?>
                            <div class="SoldOut text-center">
                                <span class="badge badge-danger text-center p-3">распроданный !</span>
                            </div>
                    <? } ?>
                                        ...
                                        <div class="col-md-6">
                                            <span class="d-block my-2 align-items-center justify-content-center">
                                                <img src="<?= base_url(); ?>assets/web-site/images/base/audition-svg/ico5.webp"
                                                     class="img-fluid" alt="Property_type">
                                                <b>Тип:</b>  <?= $data_array->Property_type; ?> <? if ($data_array->Property_type!='Commercial' AND $data_array->is_commercial=='1'){ ?> - Commercial <? } ?>
                                            </span>
                                            <span class="d-block my-2 align-items-center">
                                                <img src="<?= base_url(); ?>assets/web-site/images/base/audition-svg/ico2.webp"
                                                     alt="Property_location_city">
                                                <b>Местоположение:</b> <?= $data_array->Property_location_city; ?>
                                            </span>
                                            <span class="d-block my-2 align-items-center">
                                                 <img src="<?= base_url(); ?>assets/web-site/images/base/audition-svg/ico2.webp"
                                                      alt="Property_location">
                                                 <b>Город:</b> <?= $data_array->Property_location; ?>
                                            </span>
                                            <span class="d-block  my-2 align-items-center">
                                                <img src="<?= base_url(); ?>assets/web-site/images/base/audition-svg/ico4.webp"
                                                     alt="Property_Bathrooms">
                                                  <b>Ванные комнаты:</b> <?= $data_array->Property_Bathrooms; ?>
                                            </span>
                                        </div>
                                        <div class="col-md-6">
                                            <span class="d-block  my-2 align-items-center">
                                                  <img src="<?= base_url(); ?>assets/web-site/images/base/audition-svg/ico1.webp"
                                                       alt="Property_living_space">
                                                 <b>Пространство:</b> <?= $data_array->Property_living_space; ?> Sq.m
                                            </span>
                                            <span class="d-block my-2 align-items-center">
                                                 <img src="<?= base_url(); ?>assets/web-site/images/base/audition-svg/ico6.webp"
                                                      alt="Property_pool">
                                                 <b>Бассейн:</b> <?= $data_array->Property_pool; ?>
                                            </span>
                                            <span class="d-block my-2 align-items-center">
                                                 <img src="<?= base_url(); ?>assets/web-site/images/base/audition-svg/ico3.webp"
                                                      alt="Property_Bedrooms">
                                                  <b>Спальни:</b> <?= $data_array->Property_Bedrooms; ?>
                                            </span>
                                        </div>
                                    </div>
                                    <div class="d-none d-md-block vertical-separate"></div>
                    ...
                    <? if ($data_array->Property_why_buy_this_property){ ?>
                        <div class="card my-2">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-md-2 font-weight-bold text-center">
                                        Почему стоит купить эту недвижимость
                                    </div>
                                    <div class="col-md-10 content-font">
                ...
                <h4 class="text-center blue-text font-weight-bold">
                    <? if ($Recommended_Neighborhood_Properties) {?>
                        <div class="d-md-block">
                            Рекомендации по соседству
                        </div>

                    <?} else {?>
                        <div class="d-md-block">
                            Недавно добавленные свойства
                        </div>
                    <? } ?>
                </h4>
                <br>
                    ...
                    <? if ($Recommended_Neighborhood_Properties) {?>
                        <?if (count($Recommended_Neighborhood_Properties)>=4){?>
                            ...
                            <? foreach ($Recommended_Neighborhood_Properties as $Neighborhood_Properties){ ?>
                                <div class="item">
                                    <div class="card">
                                        <a href="<?= base_url(); ?>ru/properties/<?= $Neighborhood_Properties->url_slug; ?>" >
                                            ...
                                            <span class="card-favorite">
                                                ...
                                                <? } ?>
                                                    ...
                                                    <div id="item-card-title">
                                                        <a href="<?= base_url(); ?>ru/properties/<?= $Neighborhood_Properties->url_slug; ?>" class="text-reset font-weight-bold"
                        ...
                        <? foreach ($recently_added as $recently_properties){ ?>
                                <div class="item">
                                    <div class="card">
                                        <a href="<?= base_url(); ?>ru/properties/<?= $recently_properties->url_slug; ?>" >
...
<?php $this->load->view('web-site/ru/includes/footer',$whatsapp_passed); ?>
