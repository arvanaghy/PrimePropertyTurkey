...
<link rel="canonical" href="<?= base_url(); ?>ru/prime-videos/<?= $result->url_slug; ?>"/>
<style type="text/css">
    .social-share ul li {
        border: none;
        padding: 2%;
        ...
        <div class="container">
            <div class="row">
                <div class="col red-text py-3 text-center text-md-left">
                    ...
                    <span class="mx-2">
                        <a href="<?= base_url(); ?>ru/prime-videos" class="red-text" >
                           Videos
                        </a>
                    </span>
                    <span class="mx-2">
    ...
    <section id="content">
        <div class="container my-3">
            <div class="row justify-content-center">
                ...
                <div class="col-lg-4">
                    <?php $this->load->view('web-site/ru/includes/side-prime-talk'); ?>
                </div>
            </div>
        </div>
    </section>
