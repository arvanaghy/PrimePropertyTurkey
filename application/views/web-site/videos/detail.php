...
<meta name="twitter:image" content="<?= base_url(); ?><?= "assets/web-site/images/youtube-cover/".$result->cover_image;?> ">
            ...
            <div class="row">
                <div class="col-md-9 text-center text-md-left py-2">
                    <div class="head text-center text-md-left py-2">
                        <h1 style="font-size: 2rem"><?= $result->title; ?></h1>
                    </div>
            ...
            <div class="modal-body social-share">
                <ul class="list-group list-group-horizontal-sm justify-content-center align-items-center">
                    <li class="list-group-item">
                        <a rel="nofollow" href="https://www.facebook.com/sharer.php?u=<?= current_url(); ?>&t=<?= $result->title; ?>&p=<?= base_url();?>assets/web-site/images/youtube-cover/<?= $result->cover_image; ?>"
                           target="_blank" class="btn btn-primary btn-block">
                            <i class="fab fa-facebook"></i>
                        </a>
                    </li>
                    <li class="list-group-item">
                        <a rel="nofollow" href="https://twitter.com/intent/tweet?text=<?= current_url(); ?><?= substr(strip_tags($result->description),0,200); ?>" target="_blank" class="btn btn-info btn-block">
                            <i class="fab fa-twitter"></i>
                        </a>
                    </li>
                    <li class="list-group-item">
                        <a rel="nofollow" href="http://www.linkedin.com/shareArticle?mini=true&amp;url=<?= current_url(); ?>&amp;title=<?= $result->title; ?>&amp;ro=false&amp;summary=<?= strip_tags($result->description); ?>&amp;source=" target="_blank" class="btn btn-primary btn-block">
                            <i class="fab fa-linkedin"></i>
                        </a>
                    </li>
                    <li class="list-group-item">
                        <a rel="nofollow" href="https://pinterest.com/pin/create/button/?url=<?= current_url(); ?>&amp;description=<?= strip_tags($result->description); ?>" target="_blank" class="btn btn-danger btn-block">
