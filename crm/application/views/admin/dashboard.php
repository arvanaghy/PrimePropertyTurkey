			...
			<div class="page">
				<div class="page-inner">
				    ...
				    <div class="col-lg-12 mb-2">
				        <? $this->load->view("template/lead_search"); ?>
						...
						<div class="alert alert-danger alert-dismissible fade show row" style="color: red!important;font-size:18px;">
							...
							<? if($this->uri->segment('3')==""){ echo"1"; } else{ echo $this->uri->segment('3')+1; } ?>
							to <?= $this->uri->segment('3')+$total_lead['per_page'];  ?> of <?= $total_lead['total_rows']; ?></strong>
						</div>
						<? $this->load->view("template/lead_menu"); ?>
					</div>
					<section class="card">
						<div class="col-md-12">
							<div class="card-body pb-5">
                                <div class="pagination my-2"><?= $all_links; ?></div>
                                ...
                                <div class="table-responsive">
									<table class="table table-bordered">
										...
										<tbody>
											<? $rows = $this->User_Model->get_user_lead_list(); $counter=1;
					...
					<div class="col-lg-12 mb-2">
						...
						<div class="alert alert-danger alert-dismissible fade show row" style="color: red!important;font-size:18px;">
						    <? $rowss = $this->User_Model->get_lead_list(); ?>
							<strong>&nbsp;Enquires - you are viewing results
							<? if($this->uri->segment('3')==""){ echo"1"; } else{ echo $this->uri->segment('3')+1; } ?>
							to <?= $this->uri->segment('3')+$total_lead['per_page'];  ?> of <?php  echo $total_lead['total_rows']; ?></strong>
						</div>
							...
							<div class="card-body pb-5">
                                ...
                                <div class="table-responsive">
									<table class="table table-bordered">
										...
										<tbody>
											<?php $rows=$this->User_Model->get_lead_list();
											$counter=1;
											foreach($all_leads as $row){ ?>
                                                <tr>
