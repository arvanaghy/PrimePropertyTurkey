                ...
                <div class="page-inner">
                    <? if($this->session->userdata('type')=="1"){ ?>
                        <div class="col-lg-12 mb-2">
                            ...
                            <div class="alert alert-danger alert-dismissible fade show row" style="color: red!important;font-size:18px;">
                                <? $rowss = $this->User_Model->get_dubai_lead_list(); ?>
                            ...
                            <?php $this->load->view("template/dubai-lead-menu"); ?>
                        </div>
                    <? } ?>
                    <? if($this->session->userdata('type')=="2"){ ?>
                        <div class="col-lg-12 mb-2">
                            <?php $this->load->view("template/lead_search"); ?>
                            <div class="alert alert-danger alert-dismissible fade show row" style="color: red!important;font-size:18px;">
                                <? $rowss = $this->User_Model->user_get_dubai_lead_list(); ?>
                                <strong>&nbsp;Enquires - you are viewing results
                                    <? if($this->uri->segment('3')==""){ echo"1"; } else{ echo $this->uri->segment('3')+1; } ?>
                                    to <?= $this->uri->segment('3')+$total_lead['per_page'];  ?> of <?php  echo $total_lead['total_rows']; ?></strong>
                            </div>
                    ...
                    <div class="col-lg-12 mb-2">
                        ...
                        <div class="alert alert-danger alert-dismissible fade show row" style="color: red!important;font-size:18px;">
                            <strong>Dubai Pool Leads </strong>
                        </div>
                    </div>
                    <?php
                    if($this->session->userdata('type')=="1"){ ?>
                                ...
                                <div class="card-body pb-5">
                                    <div class="table-responsive">
                                        <table class="table table-bordered example">
                                            ...
                                            <tbody>
                                            <? $rows=$this->User_Model->get_dubai_pool_lead(); $counter=1;
                                    ...
                                    <p class="pagination"><?= $all_links; ?></p>
                                </div>
                            </div>
                        </section>
                                ...
                                <div class="card-body pb-5">
                                    <div class="table-responsive">
                                        <table class="table table-bordered example" id="example">
                                            ...
                                            <tbody>
                                            <? $rows = $this->User_Model->get_user_dubai_pool_lead(); $counter=1;
                                            foreach($rows as $row){ ?>
                                                <tr>
