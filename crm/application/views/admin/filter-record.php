									...
									<table class="table table-bordered">
										...
										<tbody>
											...
											<form action="<?php echo base_url("User/save_lead_details");?>" method="POST">
												...
												<strong>Source Of enquiry :</strong><br>	 <?php echo $row['source_of_enquiry']; ?>
													<br>
												<strong>	Ref : </strong><br> <?php echo $row['Referance_id']; ?>
													<br>
												<strong>Budget :</strong><br>	<?php echo $row['maximum_budget']; ?>
													<br>
												<strong>Originated Country :</strong> <?php echo $row['origin_country']; ?>
												</td>
												<td class="align-middle">
												<strong><?php echo $row['first_name']; 
												              echo $row['second_name'];?>
                                                </strong> <br>
												<span class="text-right"><a onclick="view_details('<?php echo $row['Lead_id']; ?>');" href="#" data-toggle="modal" data-target="#SaleModal" class="btn btn-info btn-sm" style="background-color:#2ffffd!important;border:1px solid #2ffffd;color:black;">Sale Details</a></span><br>
												<br>
