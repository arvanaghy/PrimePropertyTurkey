                ...
                <div class="page-inner">
                    <div class="col-lg-12 mb-2">
                        ...
                        <div class="alert alert-danger alert-dismissible fade show row" style="color: red!important;font-size:18px;">
                            <strong>Manage Dubai Leads</strong>
                        </div>
                    </div>
                    <form action="<?php echo base_url("User/assign_lead");?>" method="POST">
                        <div class="col-lg-12 mb-2">
                            <div class="alert alert-default alert-dismissible fade show row" style="font-size:18px;">
                                <div class="col-md-2 text-right">Select User</div>
                                <div class="col-md-7">
                                ...
                                <div class="col-md-3"><button type="submit" name="assign" class="btn btn-primary btn-block">Assign</button></div>
                            </div>
                        </div>
                        <section class="card">
                            <div class="col-md-12">
                                <div class="card-body pb-5">
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            <thead>
                                            <tr>
                                                <th><input type="checkbox" id="select_all"/><label for="select_all">All</label></th>
                                                <th>ID</th>
                                                <th> INFO</th>
                                            ...
                                            <tbody>
                                            <?php
                                            $rows=$this->User_Model->get_fresh_lead_list_dubai();
                                            $counter=1;
                                            foreach($leads as $row){ ?>
                                                <tr>
                                                    <td><span class="text-danger"><input type="checkbox" class="checkbox" name="lead_id[]" value="<?php echo $row->Lead_id ?>"></span></td>
                                                ...
                                                <tr>
                                                    <td colspan="7" class="collapse" id="collapseExample<?php echo $row->Lead_id; ?>">
                                                        <div>
