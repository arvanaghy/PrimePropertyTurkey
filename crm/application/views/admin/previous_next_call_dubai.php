                    ...
                    <div class="col-lg-12 mb-2">
                        ...
                        <div class="alert alert-danger alert-dismissible fade show row" style="color: red!important;font-size:18px;">
                            ...
                            if($this->session->userdata('type')=="1"){
                                $rows=$this->User_Model->get_previus_next_lead_list_dubai();
                                ?>
                                ...
                                <div class="card-body pb-5">
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                            <?php $rows=$this->User_Model->get_previus_next_lead_list_dubai();
                                            $counter=1;
                                ...
                                <div class="card-body pb-5">
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                            <?php $rows=$this->User_Model->get_user_previus_next_lead_list_dubai();
                                            $counter=1;
                                            foreach($previous_leads as $row){ ?>
                                                <tr>
