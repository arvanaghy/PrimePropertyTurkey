...
<html lang="en">
  <head>
    ...
    <title>Uninterested Pool Leads</title>
			...
			<div class="page">
				<div class="page-inner">
					<div class="col-lg-12 mb-2">
                        <? $this->load->view("template/Uninterested_pool_top_search"); ?>
                        <?php echo $this->session->flashdata('message'); ?>
						<div class="alert alert-danger alert-dismissible fade show row" style="color: red!important;font-size:18px;">
							<strong>Uninterested Pool Leads</strong>
						</div>
					</div>
					<?php if($this->session->userdata('type')=="1"){ ?>
				    <section class="card">						
						<div class="col-md-12">
                            <p class="pagination m-2"><?php echo $all_links; ?></p>
