                    ...
                    if($this->session->userdata('admin_user_type')!=""){
                        ...
                        <div class="col-lg-12 mb-2">
                            ...
                            <div class="alert alert-danger alert-dismissible fade show row" style="color: red!important;font-size:18px;">
                                <?php
                                $rowss=$this->User_Model->get_user_lead_list();
                                ?>
                                <strong>&nbsp;Enquires - you are viewing results
                                ...
                                <div class="card-body pb-5">
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                            <?php
                                            $rows=$this->Users_Model->get_user_lead_list_dubai();
                                            $counter=1;
