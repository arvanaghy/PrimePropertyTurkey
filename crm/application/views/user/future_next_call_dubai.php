                    ...
                    <div class="col-lg-12 mb-2">
                        ...
                        <div class="alert alert-danger alert-dismissible fade show row" style="color: red!important;font-size:18px;">
                            ...
                            if($this->session->userdata('admin_user_type')!=""){
                                $rows=$this->User_Model->get_user_future_next_lead_list();
                                ?>
                                <strong>&nbsp;Future Next Call Enquires - you are viewing results
                        ...
                        <?php $this->load->view("template/user_lead_menu_dubai"); ?>
                    </div>
                    <?php if($this->session->userdata('admin_user_type')!=""){ ?>
                        <section class="card">
                            <div class="col-md-12">
                                <div class="card-body pb-5">
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                            <?php
                                            $rows=$this->User_Model->get_user_future_next_lead_list_dubai();
                                            $counter=1;
                                            foreach($future_leads as $row){ ?>
                                                <tr>
                                                        ...
                                                        <td class="align-middle">
                                                            ...
                                                            <div class="col-md-12 mb-1">
                                                                ...
                                                                <select name="priority">
                                                                    <option <?php if($row->priority=='0'){ echo"selected"; } ?>>Set Priority</option>
                                                                    <option <?php if($row->priority=='3'){ echo"selected"; } ?> value="High">High</option>
                                                                    <option <?php if($row->priority=='2'){ echo"selected"; } ?> value="Medium">Medium</option>
                                                                    <option <?php if($row->priority=='1'){ echo"selected"; } ?> value="Low">Low</option>
                                                                </select>
                                                            </div>
                        ...
                        <p class="pagination"><?php echo $future_links; ?></p>
                    <?php } ?>
                </div>
            </div>
        </div>
