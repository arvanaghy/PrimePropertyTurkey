...
<html lang="en">
  <head>
    ...
    <title>Short Lead By - High to Low</title>
        ...
        <div class="wrapper">
			<div class="page">
				<div class="page-inner">
					<div class="col-lg-12 mb-2">
						...
						<div class="alert alert-danger alert-dismissible fade show row" style="color: red!important;font-size:18px;">
        				    ...
        				    if($this->session->userdata('admin_user_type')!=""){
        				        $rows=$this->User_Model->get_user_high_to_low_list();
        				    ?>
        				    <strong>&nbsp;High to Low Enquires - you are viewing results 
								...
								<div class="table-responsive">
									<table class="table table-bordered">
										...
										<tbody>
											...
											$rows=$this->User_Model->get_user_high_to_low_list(); 
											$counter=1;
											foreach($high_to_low_leads as $row){
											?> 
											<tr>
											<form action="<?php echo base_url("User/save_lead_details");?>" method="POST">
												...
												<strong>Budget :</strong><br><?php echo $row->maximum_budget; ?>
													<br>
												<strong>Originated Country :</strong><br><?php echo $row->origin_country; ?>
												</td>
					...
					<p class="pagination"><?php echo $high_to_low_links; ?></p>
					<?php } ?>
