...
<head>
    ...
    <title>New Enquire - Prime Property Turkey</title>
            ...
            <div class="page">
                <div class="page-inner">
                    <div class="col-lg-12 mb-2">
                        ...
                        <div class="alert alert-danger alert-dismissible fade show row" style="color: red!important;font-size:18px;">
                            ...
                            if($this->session->userdata('admin_user_type')!=""){
                                $rows=$this->User_Model->get_user_new_lead_list_dubai();
                                ?>
                                <strong>&nbsp;New List Enquires - you are viewing results
                    ...
                    if($this->session->userdata('admin_user_type')!=""){
                                ...
                                <div class="card-body pb-5">
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                            <?php
                                            $rows=$this->User_Model->get_user_new_lead_list();
                                            $counter=1;
                        ...
                        <p class="pagination"><?php echo $new_links; ?></p>
                    <?php } ?>
                </div>
            </div>
        </div>
