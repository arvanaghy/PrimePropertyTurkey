            ...
            <div class="page">
                <div class="page-inner">
                    <div class="col-lg-12 mb-2">
                        ...
                        <div class="alert alert-danger alert-dismissible fade show row" style="color: red!important;font-size:18px;">
                            ...
                            if($this->session->userdata('admin_user_type')!=""){
                                ...
                                ?>
                                <strong>&nbsp;Previus Next Call Enquires - you are viewing results
                    ...
                    if($this->session->userdata('admin_user_type')!=""){
                                ...
                                <div class="card-body pb-5">
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                            <?php
                                            $rows=$this->User_Model->get_user_previus_next_lead_list_dubai();
                                            $counter=1;
                        ...
                        <p class="pagination"><?php echo $previous_links; ?></p>
                    <?php } ?>
                </div>
            </div>
        </div>
