...
<head>
    ...
    <title>Today Call List - Prime Property Turkey</title>
            ...
            <div class="page">
                <div class="page-inner">
                    <div class="col-lg-12 mb-2">
                        ...
                        <div class="alert alert-danger alert-dismissible fade show row" style="color: red!important;font-size:18px;">
                            ...
                            if($this->session->userdata('admin_user_type')!=""){
                                $rows=$this->User_Model->get_user_today_lead_list_dubai();
                                ?>
                                <strong>&nbsp;Today Call List Enquires - you are viewing results
                    ...
                    <?php if($this->session->userdata('admin_user_type')!=""){?>
                                ...
                                <div class="card-body pb-5">
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            ...
                                            $rows=$this->User_Model->get_user_today_lead_list_dubai();
                                            $counter=1;
                                            foreach($today_call_leads as $row){
                                                ?>
                                                <tr>
                        ...
                        <p class="pagination"><?php echo $today_call_links; ?></p>
                    <?php } ?>
                </div>
            </div>
        </div>
